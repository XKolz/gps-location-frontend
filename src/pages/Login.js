...
import { FaArrowLeft, FaSpinner } from 'react-icons/fa'; // Importing arrow icon
...
function Login() {
  ...
  const { error, handleLogin, loading } = useAuth();  // Use custom hook for login logic
      ...
      <div className="login-container">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" disabled={loading}>
            {loading ? <FaSpinner className="spinners" /> : 'Login'}
          </button>
        </form>
      </div>
    </>
